...
NAN_MODULE_INIT(Init) {
  Nan::Set(v8::Isolate::GetCurrent()->GetCurrentContext(), target, Nan::New<String>("startHook").ToLocalChecked(),
  Nan::GetFunction(Nan::New<FunctionTemplate>(StartHook)).ToLocalChecked());

  Nan::Set(v8::Isolate::GetCurrent()->GetCurrentContext(), target, Nan::New<String>("stopHook").ToLocalChecked(),
  Nan::GetFunction(Nan::New<FunctionTemplate>(StopHook)).ToLocalChecked());

  Nan::Set(v8::Isolate::GetCurrent()->GetCurrentContext(), target, Nan::New<String>("debugEnable").ToLocalChecked(),
  Nan::GetFunction(Nan::New<FunctionTemplate>(DebugEnable)).ToLocalChecked());

  Nan::Set(v8::Isolate::GetCurrent()->GetCurrentContext(), target, Nan::New<String>("grabMouseClick").ToLocalChecked(),
